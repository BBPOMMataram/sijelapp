                ...
                <div class="card">
                    ...
                    <div class="card-body align-self-center">
                        ...
                        <textarea id="basegel" name="basegel" style="height: 160vh; width: 717px;">
                            ...
                            <h3 style="text-align: center; text-decoration: underline;">BERITA ACARA PEMBUKAAN SEGEL BARANG BUKTI</h3>
                            <div id="isi" style="text-align: justify;">
                                ...
                                <div id="isisuratcontainer"
                                    ...
                                    <div class="inner-wrapper">
                                        <p id="isisurat">
                                            ...
                                            {{ $produksampel->wadah1 ?? '==wadah1 tidak ditemukan==' }}. Setelah dibuka di dalamnya terdapat {{ $produksampel->wadah2kep ?? '==wadah2kep tidak ditemukan==' }}.
                                            Amplop dibuka dengan cara digunting dan Barang Bukti diambil untuk selanjutnya dilakukan Pemeriksaan Laboratorium.<span id="titikisisurat"></span>
                                         </p>
                                    </div>
                                </div>
                                ...
                                <div 
                                    ...
                                    <div class="inner-wrapper">
                                        <div>
                                            {{ '--------- Demikian Berita Acara Pembukaan Segel Barang Bukti ini dibuat dengan sebenarnya
                                            atas kekuatan sumpah jabatan dan ditandatangani di Mataram pada hari '. $tglterbilang . '.'.
                                            '--------------------------------------------------------------------------------------------'
                                            }}
                                         </div>
                                    </div>
