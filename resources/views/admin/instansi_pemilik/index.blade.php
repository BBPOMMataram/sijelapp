...
@section('content')
@include('admin.instansi_pemilik.modal')
...
<script>
    $(function(){
        ...
        $('.modal').on('click', '.submit', function(){
            ...
            let url = "{{ route('instansipemilik.store') }}";
            const id = fd.get('id');
            ...
            if(isEditMode){
                ...
                url = "{{ route('instansipemilik.update',"_id") }}";
        ...
        $('table').on('click', '.delete', function(e){
            ...
            const id = rowData['id'];
            let url = "{{ route('instansipemilik.destroy', "_id") }}";
            url = url.replace('_id', id);
        ...
        $('table').on('click', '.edit', function(e){
            ...
            $.each(rowData, function (i, v) { 
                if (i === 'imgSrc') {
                    ...
                    let el= '<div class="text-warning" id="warning-on-edit">Browse a new file to change the image</div>';
                    $('.form-group').last().before(el);
                    return;
                }
                $('input[name='+i+']').val(v);
                $('select[name='+i+']').val(v);
