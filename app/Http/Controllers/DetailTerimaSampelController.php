...
class DetailTerimaSampelController extends Controller
{
    ...
    {
        $data = ProdukSampel::with('ujiproduk', 'ujiproduk.parameter', 'ujiproduk.parameter.metodeuji', 'user', 'permintaan')
    ...
    public function index($id)
    {
        ...
        $isKepolisian = str_contains($permintaan->kategori->nama_kategori, 'polisi');

        return view('admin.terimasampel.detailterimasampel', compact('title', 'id', 'wadah1', 'wadah2', 'perihal', 'isKepolisian'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->wadah2kep = $request->wadah2kep;
    ...
    public function printbasegelkep($id)
    {
        $day = now()->dayName;
        $date = now()->day;
        $month = now()->monthName;
