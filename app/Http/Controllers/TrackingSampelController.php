    ...
    public function dtstatussampel()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($data) {
                ...
                $telp_petugas = '-';
                $resi = '-';
                $text = "berikut%20link%20untuk%20mentracking%20sampel%20skaligus%20untuk%20mendownload%20hasil%20uji%20" . env('APP_URL_BITLY', 'https://sijelapp.bbpommataram.id/') . "%20dengan%20no%20resi%20";
